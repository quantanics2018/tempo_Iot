                                    ...
                                    <div class="dropdown-filter" ref={dropdownRef3}>
                                        <div className="name_row" style={{ cursor: 'no-drop' }}>
                                            ...
                                            <div class="inputs-group relative-loc arrow_inside_input_box">
                                                ...
                                                <input type="text" value={site_id} className="form-control-loc" id="site_admin_name" onChange={handle_siteid} style={{ cursor: 'no-drop', pointerEvents: 'none' }} />
                                                <FontAwesomeIcon
                                                    icon={faChevronDown}
                                ...
                                <div class="dropdown-filter" ref={dropdownRef3}>
                                    <div className="name_row">
                                        ...
                                        <div class="inputs-group relative-loc arrow_inside_input_box" onClick={dropdown3} >
                                            <span class="input-group-loc"><Icon icon={pen_3} size={20} style={{ color: "lightgray" }} /></span>
                                            <input type="text" class="form-control-loc" id="site_admin_name" value={selected_value} />
                                            <FontAwesomeIcon
                                                icon={faChevronDown}
                                                class="dropdown-icon down_arrow arrow_inside_input"
                                            />
